...
import { FranchiseContentsUseCase } from "../../../audiovisual/application/use-case/FranchiseContentsUseCase";
...
import { FranchiseMysqlService } from "../../../audiovisual/infrastructure/service/FranchiseMysqlService";
...
const franchiseService = new FranchiseMysqlService();
...
export const ContentUserContainer = {
    ...
    getFranchiseConetents: new FranchiseContentsUseCase(contentUserRepository, franchiseService, imageUserService)
}